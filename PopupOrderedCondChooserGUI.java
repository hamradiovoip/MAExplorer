/** File: PopupOrderedCondChooserGUI.java */
...
/**
 * The PopupOrderedCondChooserGUI class is a popup class for creating ordered
 * condition chooser GUIs. It provides a panel implementing a (Remainder, 
 * Selection) GUI.
 *<P>
...
public class PopupOrderedCondChooserGUI extends Panel implements 
                                         ActionListener, WindowListener
 {
  /** instance of PopupOrderedCondChooser */
  private PopupOrderedCondChooser
    cc;
 ...
 /** panel with up/down buttons */
  ...
  /** This is either the remote instance or 'this' instance of PopupOrderedCondChooserGUI 
   * for the instance of REMAINDER to use.
   */
  PopupOrderedCondChooserGUI
    ccGUI;            
  ...
  /**
   * PopupOrderedCondChooserGUI() - constructor for base class of Chooser GUI
   * @param cc is instance of PopupOrderedCondChooser
   * @param remoteC_GUI is the alternate PopupOrderedCondChooserGUI to use if share REMAINDER
   *        else null
   * @param maxConditions is MAX # of Conditions specified by MAExplorer 
   ...
   */
  PopupOrderedCondChooserGUI(PopupOrderedCondChooser cc, PopupOrderedCondChooserGUI remoteCC_GUI, 
                      int maxConditions, int taRows, int taCols,
  ...
  /**
   * buildPopupOrderedCondChooserGUI() - create single instance GUI for Chooser.
   * @see MouseEventHandler
   */
  void buildPopupOrderedCondChooserGUI()
  { /* buildPopupOrderedCondChooserGUI */
    String
    ...
    useAbove= new Label("Use above items");        /* not to use remTextArea from above */
  ...
  { /* addObjs */
    ...
    String
      isObj,
      newRemObjList[]= new String[maxConditions]; /* temp */
  ...
  { /* delObjs */
    ...
    String
      isObj,
      newSelObjList[]= new String[maxConditions];
  ...
  { /* copyOrigToWorkingData */
    ...
    { /* use own remainder remTextArea lists instead of remote one */
      remObjList= new String[maxConditions];
    ...
    selObjList= new String[maxConditions];
  ...
  /**
   * resetPopupOrderedCondChooserGUI() - reset original data to working data, reset remTextArea and selTextArea
   * text areas. Note: allocate object lists required.
   * @see MouseEventHandler#resetMouseEventHandler
   * @see #copyOrigToWorkingData
   */
  void resetPopupOrderedCondChooserGUI()
  { /* resetPopupOrderedCondChooserGUI */
    String
      remObjListStr= "",
      selObjListStr= "";
  ...
  /**
   * toString() - pretty-print instance of this PopupOrderedCondChooserGUI
  ...
  { /* toString */
    ...
    /*   
    sR= "------------------\n"+msg+
       "\nPopupOrderedCondChooserGUI.id="+id+
       "\n title='"+title+
  ...
  { /* class MouseEventHandler */
     ...
     */
    public MouseEventHandler(PopupOrderedCondChooserGUI ccGUI, TextArea ta,
    ...
    { /* MouseReleased */
      ...
      String
        list[]= new String[maxConditions]; /* store list */
