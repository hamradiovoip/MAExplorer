...
/**
 * The class is a generic popup query dialog window used throughout MAExplorer. 
 * It displays a dialog window containing a editable 
 * TextField. There are also 2 buttons ("Ok" and "Cancel") to pass the 
 * infomormation on. If you have one button the label is "Continue".
 *<P>
      ...
      implements ActionListener, ItemListener, WindowListener 
{
   ...
   */
  PopupDialogQuery(MAExplorer mae, Frame f, int addButtonsCnt )
  { /* PopupDialogQuery */
   ...
   * @see #updatePopupDialog
   */
  float dialogQuery(String msg, float defaultValue)
  { /* dialogQuery */
    this.sleepFlag= true;	                /* flag for waiting */
    this.data= Float.toString(defaultValue);  /* save default */
    
    updatePopupDialog(msg, Float.toString(defaultValue), null, 0); /* do it */
    
    return(Util.cvs2f(this.data));            /* return float */
  } /* dialogQuery */
